...
import bitforex.domain.request.CancelOrderRequest;
import bitforex.domain.request.TradeRequest;
import bitforex.domain.response.BalanceResponse;
import bitforex.domain.response.CancelOrderResponse;
import bitforex.domain.response.OpenOrdersResponse;
import bitforex.domain.response.TradeResponse;
import bitforex.domain.response.items.SymbolsResponse;
import bitforex.rest.RestClient;
import bitforex.sign.ApiKey;
import bitforex.sign.Hmac;
...
public class BitforexRestApi {
    ...
    public static final Type SYMBOLS_RESPONSE_TYPE = new TypeToken<SymbolsResponse>() {
    }.getType();
    ...
    public SymbolsResponse getAllSymbols() throws IOException {
        final String responseText = authorizedPost(
                BASE_URL,
                "/api/v1/market/symbols",
                new HashMap<>()
        );
        return gson.fromJson(responseText, SYMBOLS_RESPONSE_TYPE);
    }
